...
const description = "This is an NFT made by OkGaree.";
...
const baseImageUri = "https://billyg/nft";
...
let rarityWeights = [
  addRarity('super_rare', 10, 10),
  addRarity('rare', 20, 50),
  addRarity('original', 50, 100),
];
...
const layers = [
  addLayer('G BG', { x: 0, y: 0 }, { width: width, height: height }),
  addLayer('G Body'),
  addLayer('G Clothes'),
  addLayer('G Eyes'),
  addLayer('G Horns'),
...
addRarityPercentForLayer('super_rare', 'G BG', { 'super_rare': 33, 'rare': 33, 'original': 33 });
addRarityPercentForLayer('super_rare', 'G Clothes', { 'super_rare': 50, 'rare': 25, 'original': 25 });
addRarityPercentForLayer('original', 'G Clothes', { 'super_rare': 50, 'rare': 25, 'original': 25 });
